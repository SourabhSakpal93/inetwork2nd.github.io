        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="<?php echo $item['item_image'] ?? "./assets/products/iphone/Apple iPhone 11 (128GB) - Green.jpg" ?>" style="height: 100px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                ...
                <!-- !cart item -->
                 <?php
                     ...
                     },$cart);//This is a closing array map function
                 endforeach;
                 ?>
            </div>
            <!-- subtotal section-->
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-rubik font-size-20">Sub total ( <?php echo isset($subTotal) ? count($subTotal) : 0; ?> item )<span class="text-danger">₹<span class="text-danger" id="deal-price"><?php echo isset($subTotal) ? $Cart->getSum($subTotal) : 0; ?></span> </span> </h5>
